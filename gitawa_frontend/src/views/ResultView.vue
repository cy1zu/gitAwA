<template>
    <div v-loading="loading">
        ...
        <div style="display: flex; margin: 3%; margin-top: 4.5vw; margin-left: 5.5vw" v-show="allpage">
...
<script setup>
    ...
    setTimeout(() => {
        ...
        axios.get('https://api.github.com/users/'+login.value).then(res => {
            ...
            localtion.value = res.data.location
        ...
        axios.get('api/developers/'+login.value).then(res => {
            ...
            if (res.data.login == null) {
                ...
                emptyDesc.value = res.data.msg
            } else {
                showDetail.value = true
                talentRank.value = Number(userData.value.talent_rank).toFixed(0).toString()+'pp'
                
                if (userData.value.localtion == null || userData.value.localtion == '') {
